...
cd /d H:\monailabel\soilcores3dsegmentation
...
REM Run experiment 2 (DynUNet with varying upper thresholds and vertical view)
set /a exp_count+=1
echo ============================================================
echo Running Experiment !exp_count!: DynUNet with varying upper thresholds and vertical view
echo ============================================================
!exp2!
...
REM echo.
REM echo ============================================================
REM echo Running Experiment !exp_count!: DynUNet with varying lower thresholds and vertical view
REM echo ============================================================
REM !exp3!
...
REM echo.
REM echo ============================================================
REM echo Running Experiment !exp_count!: DynUNet with varying upper thresholds and horizontal view
REM echo ============================================================
REM !exp4!
...
REM echo.
REM echo ============================================================
REM echo Running Experiment !exp_count!: DynUNet with varying lower thresholds and horizontal view
REM echo ============================================================
REM !exp5!
...
REM echo.
REM echo ============================================================
REM echo Running Experiment !exp_count!: UNet 100k with varying lower thresholds and vertical view
REM echo ============================================================
REM !exp6!
...
REM echo.
REM echo ============================================================
REM echo Running Experiment !exp_count!: UNet 100k with varying upper thresholds and vertical view
REM echo ============================================================
REM !exp7!
...
REM echo.
REM echo ============================================================
REM echo Running Experiment !exp_count!: UNet 100k with varying lower thresholds and horizontal view
REM echo ============================================================
REM !exp8!
...
REM echo.
REM echo ============================================================
REM echo Running Experiment !exp_count!: UNet 100k with varying upper thresholds and horizontal view
REM echo ============================================================
REM !exp9!
...
REM echo.
REM echo ============================================================
REM echo Running Experiment !exp_count!: UNet default with varying lower thresholds and vertical view
REM echo ============================================================
REM !exp10!
...
REM echo.
REM echo ============================================================
REM echo Running Experiment !exp_count!: UNet default with varying upper thresholds and vertical view
REM echo ============================================================
REM !exp11!
...
REM echo.
REM echo ============================================================
REM echo Running Experiment !exp_count!: UNet default with varying lower thresholds and horizontal view
REM echo ============================================================
REM !exp12!
...
REM echo.
REM echo ============================================================
REM echo Running Experiment !exp_count!: UNet default with varying upper thresholds and horizontal view
REM echo ============================================================
REM !exp13!
...
REM echo.
REM echo ============================================================
REM echo Running Experiment !exp_count!: UNETR with varying lower thresholds and vertical view
REM echo ============================================================
REM !exp14!
...
REM echo.
REM echo ============================================================
REM echo Running Experiment !exp_count!: UNETR with varying upper thresholds and vertical view
REM echo ============================================================
REM !exp15!
...
REM echo.
REM echo ============================================================
REM echo Running Experiment !exp_count!: UNETR with varying lower thresholds and horizontal view
REM echo ============================================================
REM !exp16!
...
REM echo.
REM echo ============================================================
REM echo Running Experiment !exp_count!: UNETR with varying upper thresholds and horizontal view
REM echo ============================================================
REM !exp17!
