# Example usage:
# python soilcore_cli_v2.py --nifti-dir D:\monailabel\datasets\soilcores\test --model unet_dataset_2_default --lower 0.0 --upper 100.0 --view horizontal --pixels-per-range 2 --num-ranges 5 --outputs-dir outputs --gt-csv D:\monailabel\soilcores3dsegmentation\gt\CoresGT.csv
# python soilcore_cli_v2.py --nifti-dir D:\monailabel\datasets\soilcores\test --model unet_dataset_2_default --lower 0.0 --upper 60.0 --view vertical --pixels-per-range 2 --num-ranges 5 --outputs-dir outputs --gt-csv D:\monailabel\soilcores3dsegmentation\gt\CoresGT.csv
# python soilcore_cli_v2.py --nifti-dir D:\monailabel\datasets\soilcores\test --model dataset_2adamw_100k_num_heads_2 --lower 0.0 --upper 60.0 --view vertical --pixels-per-range 2 --num-ranges 5 --outputs-dir outputs --gt-csv D:\monailabel\soilcores3dsegmentation\gt\CoresGT.csv
